      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        {currentTab === 'bankingpartner' && (
          <div className="lg:col-span-12 space-y-6">
            ...
            {/* Top Form Card */}
            <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-xs relative">
                        ...
                        {bpEditBanksDropdownOpen && (
                          <>
                            ...
                            <div className="absolute top-full left-0 w-full mt-1.5 bg-white border border-slate-200 rounded-2xl shadow-2xl p-3 z-50 space-y-2.5 max-h-72 flex flex-col">
                              ...
                              {(() => {
                                const filteredBanks = filterBanksFuzzy(bankMastersList, bpEditBankSearchQuery);
                                return (
                                  <>
                                    <div className="flex items-center justify-between border-b border-slate-100 pb-2 px-1 text-[11px] font-bold">
                                      <span className="text-slate-400 font-bold">
                                      ...
                                      <div className="flex items-center gap-3">
                                        <button
                                          type="button"
                                          onClick={() => {
                                            const combined = Array.from(new Set([...selectedEditBanks, ...filteredBanks]));
                                    ...
                                    <div className="space-y-1 overflow-y-auto pr-1 flex-1 max-h-48">
                                      {filteredBanks.length === 0 ? (
                                        ...
                                        filteredBanks.map((bankName) => {
                                          const isChecked = selectedEditBanks.some(b => isBankMatch(b, bankName));
                                          return (
                                            <button
                                              key={bankName}
                                              type="button"
